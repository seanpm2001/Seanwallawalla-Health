...
🟦️📃️🇨🇭️ A list of health projects produced by @seanwallawalla (the lower branch of @seanpm2001)

> **Note** For newer entries, see [:octocat: `Seanpm2001-Health`](https://github.com/seanpm2001/Seanpm2001-Health/)

***

## Listing

Only 2 repositories are from this era:
...
The flag of Switzerland `🇨🇭️` is used for this project, as it is the closest I could get to a medkit or a red cross.

***

## Old page

The old page can be found [:octocat: `here`](https://github.com/seanpm2001/Seanpm2001-GitHub-Pages-Collection/tree/Seanpm2001-GitHub-Pages-Collection_Main-dev/Gh-Pages/Seanwallawalla-health.github.io/)

<details><summary><p><b>Click/tap here to expand the old page</b></p></summary>
...
**File version:** `1 (2023, Wednesday, February 1st at 4:11 pm PST)`
